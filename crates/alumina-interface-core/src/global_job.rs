...
fn participant_record(package: &MachineJobParticipantPackage2) -> MachineJobParticipant {
    ...
    MachineJobParticipant {
        ...
        axis_count: 2,
        execution_kind: partition.execution_kind(),
        dense_update_period_ticks: partition.dense_update_period_ticks(),
        maximum_dense_updates: partition.maximum_dense_updates(),
